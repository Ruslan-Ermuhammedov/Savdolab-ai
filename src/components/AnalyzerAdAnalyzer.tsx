    ...
    <div className="flex flex-col gap-6" id="report-content">
      <div className="bg-[#111827] border border-white/10 rounded-[24px] p-6 shadow-2xl">
        <div className="flex items-center gap-3 mb-8">
           ...
           <h2 className="text-2xl font-bold text-white">{t('analyzer.modeLabels.ad-analyzer')}</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
           <div className="bg-gradient-to-b from-[#111827] to-[#1A2333] p-5 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center">
             <div className="text-[10px] text-white/50 uppercase tracking-widest mb-2 font-bold">{t('reports.hookScore')}</div>
             <div className="text-4xl font-black text-[#89E4FF]">{data.hookScore}</div>
           </div>
           <div className="bg-gradient-to-b from-[#111827] to-[#1A2333] p-5 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center">
             <div className="text-[10px] text-white/50 uppercase tracking-widest mb-2 font-bold">{t('reports.creativityScore')}</div>
             <div className="text-4xl font-black text-purple-400">{data.creativityScore}</div>
           </div>
           <div className="bg-gradient-to-b from-[#111827] to-[#1A2333] p-5 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center">
             <div className="text-[10px] text-white/50 uppercase tracking-widest mb-2 font-bold">{t('reports.conversionScore')}</div>
             <div className="text-4xl font-black text-green-400">{data.conversionScore}</div>
           </div>
           <div className="bg-gradient-to-b from-[#111827] to-[#1A2333] p-5 rounded-xl border border-white/10 flex flex-col items-center justify-center text-center">
             <div className="text-[10px] text-white/50 uppercase tracking-widest mb-2 font-bold">{t('reports.trustScore')}</div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
           <div className="bg-white/5 rounded-xl p-5 border border-white/5">
              <h3 className="text-sm font-semibold text-white/70 uppercase tracking-wide mb-3">{t('reports.hookAnalysis')}</h3>
              <p className="text-sm text-white/90 leading-relaxed">{data.hookAnalysis}</p>
           </div>
           <div className="bg-white/5 rounded-xl p-5 border border-white/5">
              <h3 className="text-sm font-semibold text-white/70 uppercase tracking-wide mb-3">{t('reports.offerAnalysis')}</h3>
              <p className="text-sm text-white/90 leading-relaxed">{data.offerAnalysis}</p>
           </div>
           <div className="bg-white/5 rounded-xl p-5 border border-white/5">
              <h3 className="text-sm font-semibold text-white/70 uppercase tracking-wide mb-3">{t('reports.ctaAnalysis')}</h3>
              <p className="text-sm text-white/90 leading-relaxed mb-4">{data.ctaAnalysis}</p>
              <div className="h-px w-full bg-white/10 mb-4" />
              <div className="text-xs text-white/50 uppercase mb-1">{t('reports.targetAudience')}</div>
        ...
        <div className="bg-black/20 rounded-xl p-5 border border-white/5 mb-8">
           <h3 className="text-sm font-semibold text-white/50 uppercase tracking-wide mb-4">{t('reports.emotionTriggers')}</h3>
        ...
        <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl p-6 border border-blue-500/20">
           <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
             <Lightbulb className="text-yellow-400" /> {t('reports.newAdVariants')}
           </h3>
