  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (err?.code === 'auth/popup-blocked') {
        setErrorMsg('Tizimga kirish uchun brauzeringizda pop-up oynalarga ruxsat bering (yoki ilovani yangi oynada oching).');
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <h3 className="text-2xl font-bold mb-3 text-center">Tizimga Kiring</h3>
        <p className="text-white/60 mb-8 text-center text-sm">Savdolab imkoniyatlaridan foydalanish uchun tizimga kiring.</p>
